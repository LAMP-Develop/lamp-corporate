...
// アイキャッチ設定
add_theme_support('post-thumbnails', array('post','page','cta'));
...
{
    add_editor_style('https://fonts.googleapis.com/css?family=Lato:400,700');
    add_editor_style('https://use.fontawesome.com/releases/v5.0.8/css/all.css');
